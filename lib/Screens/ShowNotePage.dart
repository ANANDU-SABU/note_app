  ...
  Widget build(BuildContext context)
  {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xffF2F3F7),
        elevation: 0,
        title: TextAs(text: widget.note.title!, fontWeight: FontWeight.w500, fontSize: 17 ),
        centerTitle: true,
        leading: InkWell(
          onTap: () => Navigator.pop(context),
          child: Center(
            child: TextAs(text: 'Cancel', fontSize: 15, color: Color(0xff0C6CF2),)
          )
        ),
        actions: [
          InkWell(
            ...
            child: Container(
              ...
              width: 60,
              child: TextAs(text: 'Save', fontSize: 15, color: Color(0xff0C6CF2),)
            ),
          )
        ],
      ),
